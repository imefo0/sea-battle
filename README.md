...
>**-f**    --fast            быстрый старт
>                            (автоматически -c -r -s 1 -m 1111222334 -b harpooner -t player)
...
>**-b**    --bot             тип бота
>**-m**    --method          метод расстановки (цифра - это кол-во палуб, а кол-во самих цифр - кол-во таких кораблей, например 1111222334 - 4 однопалубных,
>                            3 двухпалубных, 2 трехпалубных и 1 четырехпалубный)
